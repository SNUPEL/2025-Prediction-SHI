...
def create_config():
    ...
    # config['split_cutoff_date'] = '2023-01-01'  # 굉장히 넉넉히 줄 것
    config['split_cutoff_date'] = '2020-08-01'  # 굉장히 넉넉히 줄 것
    ...
    config['SMOTE_sampling_strategy'] = 0.5
    ...
    config['model_type'] = 'AutoEncoder'  # 사용할 모델 타입
    ...
    # model parameter:
    config['AdaBoost_parameter'] = {'n_estimators': 1000, "learning_rate": 0.001}
    # config['AdaBoost_estimator_parameter'] = {'max_depth': 4, 'min_samples_split': 2}
    config['class_weight'] = {0: 1, 1: 2000}
    config['epochs'] = 500
    # 학습된 모델 저장 여부 설정
